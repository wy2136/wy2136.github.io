...
function write_publications(ifile='./json/publications.json'){
    ...
    for (i=0;i<N;i++)
    {
        ...
        var bibString = '<span class="label label-default">' + (N-i).toString().padStart(2, '0') +  '</span> <a href="' + url + '" class="">' + title + '</a><br>' + author + '<br> <span  class="text-muted"><i>' + journal + ',</i> ' + year + '. doi: ' + doi + '</span> <a href="'+pdffile+'" class="text-muted"><span class="glyphicon glyphicon-download-alt"></span></a>';
