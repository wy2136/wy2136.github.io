...
pyscript=/tigress/wenchang/CM2.5_tiger2_wy/CM2.5/exp/wylink_exp.py
dirs="
/tigress/wenchang/CM2.5_tiger2_wy/CM2.5/exp
/tigress/wenchang/CM2.5_tiger2_wy/CM2.5/exp_killtc
"
for d in $dirs; do
    cd $d
    echo pwd: $(pwd)
